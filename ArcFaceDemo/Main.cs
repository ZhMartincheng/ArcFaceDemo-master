...
namespace FaceRecognization
{
	public partial class Main : Form
	{
		...
		/// 虹软SDK的AppId
		/// </summary>
		const string AppId = "SvnzpMjMWRRYtv4445MsxbUKEc3fz93SkprFgJAgFAn";
		/// <summary>
		/// 虹软SDK人脸检测的Key
		/// </summary>
		const string DKey = "41hA3sMycXiZ9NQn8kTchQCidwtq11WiV7NAf4CAEs9U";
		/// <summary>
		/// 虹软SDK人脸比对的Key
		/// </summary>
		const string RKey = "41hA3sMycXiZ9NQn8kTchQDDHYwVyoLr4vf8KcdVSHh4";
		...
		{
			if (ArcFace.Api.FaceResults == null) return;
